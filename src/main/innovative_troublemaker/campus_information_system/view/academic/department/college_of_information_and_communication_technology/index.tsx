                ...
                <main id="col-ict">
                    ...
                    <section className="teacher-section" id="faculty-section">
                        ...
                        <div className="teacher-list">
                            {[
                                { name: "Mr. John Smith", role: "ICT Instructor", image: "/resources/academic/department/college_of_ict/img/teachers_pic/pic1.jpg" },
                                { name: "Ms. Jane Doe", role: "Web Development Mentor", image: "/resources/academic/department/college_of_ict/img/teachers_pic/pic2.jpg" },
                                { name: "Mr. Alex Cruz", role: "Database Administrator", image: "/resources/academic/department/college_of_ict/img/teachers_pic/pic3.jpg" },
                                { name: "Ms. Maria Lopez", role: "Cybersecurity Specialist", image: "/resources/academic/department/college_of_ict/img/teachers_pic/pic4.jpg" },
                                { name: "Mr. Liam Brown", role: "AI and ML Instructor", image: "/resources/academic/department/college_of_ict/img/teachers_pic/pic5.jpg" },
                                { name: "Ms. Ella Green", role: "IT Project Manager", image: "/resources/academic/department/college_of_ict/img/teachers_pic/pic6.jpg" },
                                { name: "Mr. Oliver White", role: "Network Engineer", image: "/resources/academic/department/college_of_ict/img/teachers_pic/pic7.jpg" },
                                { name: "Ms. Sophia Blue", role: "Data Scientist", image: "/resources/academic/department/college_of_ict/img/teachers_pic/pic8.jpg" },
                                { name: "Mr. Kevin Gray", role: "System Analyst", image: "/resources/academic/department/college_of_ict/img/teachers_pic/pic9.jpg" },
                            ].map((teacher, index) => (
